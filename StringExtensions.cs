...
#else
		static string[] SplitByCharacters (this string s, char[] sep, int count, bool removeEmpty)
			{
			if (sep == null || sep.Length == 0)
				sep = WhiteChars;
		...
		internal static int IndexOfUnchecked (this string s, char value, int startIndex, int count)
			...
			const int startIx = 0;
				...
				while (ptrIx != end_ptrIx)
					{
					if (s[ptrIx] == value_32)
						return (int)(ptrIx - startIx);
					if (s[ptrIx + 1] == value_32)
						return (int)(ptrIx - startIx + 1);
					if (s[ptrIx + 2] == value_32)
						return (int)(ptrIx - startIx + 2);
					if (s[ptrIx + 3] == value_32)
						return (int)(ptrIx - startIx + 3);
					if (s[ptrIx + 4] == value_32)
						return (int)(ptrIx - startIx + 4);
					if (s[ptrIx + 5] == value_32)
						return (int)(ptrIx - startIx + 5);
					if (s[ptrIx + 6] == value_32)
						return (int)(ptrIx - startIx + 6);
					if (s[ptrIx + 7] == value_32)
						return (int)(ptrIx - startIx + 7);
